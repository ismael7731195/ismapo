function Invoke-DatabaseDiagnostics {
    ...
    $cs = 'Server={0};Database={1};Integrated Security=True;Application Name=AGROINPACO_M02_P03_D01_REV2;Encrypt=False;TrustServerCertificate=True;ApplicationIntent=ReadOnly' -f $Server, $DatabaseName
...
"@
    ...
    if ($errors.Count -eq 0) {
        return 'EJECUTADO_SOLO_LECTURA_COMPLETO'
    }
    return ('INCOMPLETO_CON_ERRORES=' + $errors.Count)
}
